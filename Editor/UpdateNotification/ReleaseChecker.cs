...
namespace Net._32ba.AnimSynth.UpdateNotification
{
    [InitializeOnLoad]
    internal static class ReleaseChecker
    {
        private const string PackageId = "net.32ba.anim-synth";
        private const string PackageDisplayName = "Anim Synth";
        private const string ReleasePageUrl = "https://github.com/32ba/VRC-anim-synth/releases";
        private const string LastCheckKeyPrefix = "net.32ba.anim.synth.LastVersionCheck";
